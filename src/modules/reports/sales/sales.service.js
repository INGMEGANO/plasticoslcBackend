...
export const getSalesSummaryService = async ({ from, to }) => {
...
export const getSalesListService = async ({ from, to }) => {
...
export const getSalesSummaryFormattedService = async ({ from, to }) => {
